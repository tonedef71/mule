...
public class FlowVarExpressionDataTypeResolverTestCase extends AbstractMuleContextTestCase
{
    ...
    private final ExpressionDataTypeResolver expressionDataTypeResolver = new FlowVarExpressionDataTypeResolver();
    private final String variableName = "flowVars";
    ...
    protected void doVarDataTypeTest(String expression) throws Exception
    {
        ...
        testEvent.setFlowVariable(PROPERTY_NAME, EXPRESSION_VALUE, expectedDataType);
