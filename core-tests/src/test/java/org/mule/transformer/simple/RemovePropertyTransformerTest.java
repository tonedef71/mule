...
@SmallTest
public class RemovePropertyTransformerTest extends AbstractMuleTestCase
{
    ...
    private RemovePropertyTransformer removePropertyTransformer = new RemovePropertyTransformer();
    ...
    public void setUpTest()
    {
        ...
        removePropertyTransformer.setMuleContext(mockMuleContext);
    ...
    {
        removePropertyTransformer.setIdentifier(PLAIN_STRING_KEY);
        removePropertyTransformer.initialise();
        removePropertyTransformer.transform(mockMessage, ENCODING);
    ...
    {
        removePropertyTransformer.setIdentifier(EXPRESSION);
        removePropertyTransformer.initialise();
        removePropertyTransformer.transform(mockEvent, ENCODING);
    ...
    {
        when(mockMessage.getPropertyNames(scope)).thenReturn(new HashSet<String>(Arrays.asList("MULE_ID","MULE_CORRELATION_ID","SomeVar","MULE_GROUP_ID")));
        removePropertyTransformer.setIdentifier("MULE_(.*)");
        removePropertyTransformer.initialise();
        removePropertyTransformer.transform(mockMessage, ENCODING);
