...
@SmallTest
public class AddSessionVariableTransformerTestCase extends AbstractMuleTestCase
{
    ...
    private AddSessionVariableTransformer addVariableTransformer;
    ...
    {
        addVariableTransformer = new AddSessionVariableTransformer();
    ...
    public void testAddVariable() throws InitialisationException, TransformerException
    {
        ...
        verify(mockSession).setProperty(argThat(equalTo(PLAIN_STRING_KEY)), argThat(equalTo(PLAIN_STRING_VALUE)), dataTypeCaptor.capture());
    ...
    public void testAddVariableWithExpressionValue() throws InitialisationException, TransformerException
    {
        ...
        verify(mockSession).setProperty(argThat(equalTo(PLAIN_STRING_KEY)), argThat(equalTo(EXPRESSION_VALUE)), dataTypeCaptor.capture());
        assertThat(dataTypeCaptor.getValue(), DataTypeMatcher.like(String.class, MimeTypes.ANY, null));
    }
    ...
    public void testAddVariableWithExpressionKey() throws InitialisationException, TransformerException
    {
        ...
        verify(mockSession).setProperty(argThat(equalTo(EXPRESSION_VALUE)), argThat(equalTo(PLAIN_STRING_VALUE)), dataTypeCaptor.capture());
        assertThat(dataTypeCaptor.getValue(), DataTypeMatcher.like(String.class, MimeTypes.ANY, null));
    }
            ...
            throws InitialisationException, TransformerException
    {
        ...
        addVariableTransformer.initialise();
        addVariableTransformer.transform(mockEvent, ENCODING);
        verify(mockSession, VerificationModeFactory.times(0)).setProperty((String) isNull(), anyString());
    }
            ...
            throws InitialisationException, TransformerException
    {
        ...
        addVariableTransformer.initialise();
        addVariableTransformer.transform(mockEvent, ENCODING);
        verify(mockSession, VerificationModeFactory.times(1)).removeProperty(PLAIN_STRING_KEY);
    }
