...
public class PropertiesDescriptorParser implements DescriptorParser
{
    ...
    public PropertiesDescriptorParser(ClassLoaderLookupPolicyParser classLoaderLookupPolicyParser)
    {
    ...
    public ApplicationDescriptor parse(File descriptor, String applicationName) throws IOException
    {
        ...
        final ClassLoaderLookupPolicy classLoaderLookupPolicy = classLoaderLookupPolicyParser.parse(p.getProperty(PROPERTY_LOADER_OVERRIDE));
