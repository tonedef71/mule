...
public class SessionVarExpressionDataTypeResolverTestCase extends AbstractMuleContextTestCase
{
    ...
    private final ExpressionDataTypeResolver expressionDataTypeResolver = new SessionVarExpressionDataTypeResolver();
    private final String variableName = "sessionVars";
    ...
    protected void doVarDataTypeTest(String expression) throws Exception
    {
        ...
        testEvent.getSession().setProperty(PROPERTY_NAME, EXPRESSION_VALUE, expectedDataType);
